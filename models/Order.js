...
export default class Order extends Model {
    static init(sequelize) {
        return super.init({
            ...
            // Hubungan ke Billing (Master Invoice)
            billing_id: {
                type: DataTypes.UUID,
                allowNull: true, // Ubah ke false setelah migrasi data lama selesai jika perlu
    ...
    static associate(models) {
        // Relasi baru: Order adalah bagian dari Billing
